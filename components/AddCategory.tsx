...
interface Props {
  visible: boolean;
  onClose: () => void;
  onAddCategory: (newCategory: string, publishNow: boolean) => void
}
...
const AddCategory: React.FC<Props> = ({ visible, onClose, onAddCategory}) => {
  ...
  const handleAddCategory = () => {
    ...
    onAddCategory(categoryName, publishNow)
    setCategoryName("")
    setPublishNow(false)
    onClose()
